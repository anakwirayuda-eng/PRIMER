...
export const KASUS_SARAF_MATA_THT: KasusKlinis[] = [
   ...
   * ==================================================================== */
  {
    ...
    clue: 'Bangkitan tak beralasan BERULANG (≥2 kali, jeda >24 jam, tanpa demam/pencetus akut) memenuhi definisi epilepsi → butuh EEG + pemilihan OAE jangka panjang oleh SPESIALIS SARAF. Peran FKTP: stabilisasi (diazepam untuk bangkitan berkepanjangan/status epileptikus), pertolongan pertama aman, edukasi keluarga, lalu RUJUK. Jangan mulai OAE rumatan sendiri tanpa klasifikasi (PPK PERDOSSI).',
    konsekuensi: {
