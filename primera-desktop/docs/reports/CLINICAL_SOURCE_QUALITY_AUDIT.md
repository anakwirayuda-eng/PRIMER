...
|---|---:|---|---|
| WHO Clinical Management of Acute Pesticide Intoxication | 2008 | Manual WHO yang masih menjadi rujukan klinis organofosfat; dipakai bersama algoritme resusitasi dan tidak ditafsirkan sebagai daftar inventaris FKTP. | igd:igd_keracunan_organofosfat |
...
| Kyoto Global Consensus Report on Helicobacter pylori Gastritis (Gut, mirror PMC/NIH) | 2015 | Konsensus fondasional (Sugano dkk, Gut 2015) yang masih dikutip aktif di literatur 2023-2024 sbg klasifikasi gastritis kronis berbasis etiologi; tidak ada revisi resmi fakultas yang sama. | poli:gastritis |
| American Thyroid Association - Guidelines for Diagnosis and Management of Hyperthyroidism and Other Causes of Thyrotoxicosis | 2016 | Masih tercantum sebagai guideline aktif ATA untuk hipertiroidisme; kasus membatasi penggunaannya pada populasi dewasa nonhamil. | poli:lab_hipertiroid_graves |
...
| Cochrane Review: Interventions for an Acute Internal Hordeolum | 2017 | Update pub4 (2017) dari seri 2009/2010/2013; tidak ada pub5. Review menyimpulkan ketiadaan RCT memadai, dipakai sbg dasar status opsional (bukan wajib) pada tata laksana kasus. | poli:mata_hordeolum |
| World Society of Emergency Surgery - 2017 update of the WSES guidelines for emergency repair of complicated abdominal wall hernias | 2017 | Masih merupakan update WSES diagnosis-spesifik untuk hernia inkarserata/strangulata dan source control emergensi. | poli:lab_hernia_inguinalis_inkarserata |
| European Association for the Study of the Liver - EASL Clinical Practice Guidelines for the management of patients with decompensated cirrhosis | 2018 | Pedoman EASL sindrom dekompensasi yang masih relevan; dipakai bersama sumber ascites/komplikasi yang lebih baru. | poli:lab_sirosis_hepatis_dekompensata |
| NIDDK - Diagnosis and Management of Lactose Intolerance | 2018 | Halaman klinis NIDDK yang masih aktif untuk diagnosis dan uji eliminasi-terkontrol; bukan sumber dosis obat. | poli:lab_intoleransi_makanan_laktosa |
| WHO/ICRC Basic Emergency Care | 2018 | Kursus first-contact WHO/ICRC fondasional untuk ABCDE, transfer, dan handover di fasilitas terbatas. | igd:igd_kejang_demam, igd:igd_luka_bakar_luas, igd:igd_pneumotoraks_tension_trauma, poli:lab_trauma_tajam_kulit_kepala, poli:lab_vulnus_laseratum_lengan |
| World Health Organization - Guidelines for the diagnosis, treatment and prevention of leprosy | 2018 | Pedoman WHO diagnosis dan MDT yang masih aktif; aspek kontak diperbarui oleh sumber WHO yang lebih baru. | poli:lab_kusta_pausibasiler |
...
| EPOS 2020 - Rhinosinusitis and Nasal Polyps | 2020 | EPOS 2020 tetap pedoman komprehensif aktif untuk rinosinusitis; update yang lebih baru tidak menggantikan seluruh algoritmenya. | poli:tht_rinosinusitis_akut |
| WSES Guidelines for Acute Calculous Cholecystitis | 2020 | Masih menjadi guideline WSES diagnosis-spesifik untuk kolesistitis akut dan ambang source control. | poli:lab_kolesistitis_akut |
