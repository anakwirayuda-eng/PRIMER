...
export const KASUS_IGD_LAB_2 = terapkanGroundingIgd([
  /* ====================================================================== */
  {
    ...
    clue:
      'Tenggelam membunuh lewat HIPOKSIA. Urutannya: buka jalan napas dan bersihkan hanya sumbatan nyata → berikan napas bantuan/ventilasi dengan oksigen sedini mungkin → nilai sirkulasi dan mulai RJP bila perlu → lepas pakaian basah, keringkan, dan hangatkan bertahap. JANGAN mencoba mengeluarkan air dengan hentakan perut, Heimlich rutin, atau posisi kepala di bawah: manuver itu menunda ventilasi dan memicu regurgitasi. Antibiotik serta kortikosteroid tidak diberikan profilaktik. Korban yang sempat tidak sadar, apnea, atau membutuhkan bantuan napas dirujuk untuk observasi walau tampak pulih. PPK FKTP 1186/2022 tidak memuat bab khusus; algoritme ini mengikuti Wilderness Medical Society Drowning Guideline 2024, ANZCOR Resuscitation in Special Circumstances 2026, dan AHA Special Circumstances of Resuscitation 2025.',
    langkah: [
      {
        id: 'tgl_1',
        narasi:
  ...
  /* ====================================================================== */
  {
    ...
    spesialisRujukan: 'penyakit_dalam',
    clue:
      'Organofosfat menimbulkan sindrom kolinergik: air liur dan air mata berlebih, diare, bronkorea, bronkospasme, bradikardia, pupil kecil, fasikulasi, dan kelemahan otot. Ancaman awal terbesar adalah sekret jalan napas dan kelemahan otot napas. Lindungi penolong, lepaskan pakaian terkontaminasi, lalu cuci kulit serta rambut dengan sabun dan air. Kerjakan dekontaminasi bersamaan dengan pengamanan jalan napas, pengisapan sekret, dan oksigen. Titrasi atropin berulang dengan dosis yang digandakan sampai bronkorea dan bronkospasme terkendali serta air entry, oksigenasi, dan perfusi membaik. Pasien tidak perlu mencapai keadaan tanpa sekret sama sekali; ukuran pupil dan jumlah ampul bukan titik akhir terapi. Pralidoksim dan penanganan sindrom perantara merupakan ranah rumah sakit. Rujuk dengan atropin rumatan serta oksigen berjalan, dan sertakan nama atau wadah pestisida bila aman. Acuan: prinsip toksikologi klinis dan panduan keracunan pestisida WHO.',
    langkah: [
      {
        id: 'ops_1',
        narasi:
  ...
  /* ====================================================================== */
  {
    ...
    spesialisRujukan: 'penyakit_dalam',
    clue:
      'Bisa viperid cenderung menyebabkan bengkak progresif, nekrosis, dan koagulopati; bisa elapid lebih sering bersifat neurotoksik. Tenangkan pasien dan imobilisasi anggota gerak yang tergigit dengan bidai. Ikatan ketat yang sudah terpasang JANGAN dilepas mendadak: pelepasannya dikerjakan terkontrol ketika resusitasi, adrenalin IM, pemantauan, antivenom yang sesuai, dan petugas kompeten benar-benar siap. Akses IV saja tidak cukup. Jangan memasang torniket baru, menginsisi, mengisap, memberi es, atau menempelkan ramuan. Bersihkan luka, tutup dengan kasa steril, lalu tandai batas bengkak beserta waktunya dan ukur progresinya. Hindari NSAID serta suntikan intramuskular bila ada koagulopati. Antibisa hanya diberikan bila ada envenomasi sistemik atau progresi lokal cepat, di fasilitas yang siap menangani anafilaksis. Rujuk semua kasus envenomasi dengan waktu gigitan tercatat. Acuan: pedoman gigitan ular Kemenkes dan WHO Asia Tenggara.',
    langkah: [
      {
        id: 'ular_1',
        narasi:
  ...
  /* ====================================================================== */
  {
    ...
    spesialisRujukan: 'penyakit_dalam',
    clue:
      'Sepsis adalah disfungsi organ akibat respons tubuh yang tidak terkendali terhadap infeksi. Di FKTP, sumber infeksi disertai hipotensi, akral dingin, pengisian kapiler memanjang, kesadaran menurun, takipnea, atau urin berkurang sudah cukup untuk bertindak. Jangan menunggu laktat atau kultur yang tidak tersedia. SSC 2026 menganjurkan kristaloid hingga sekitar 30 mL/kg dalam tiga jam pertama pada syok, diberikan bertahap dengan penilaian ulang perfusi dan tanda kelebihan cairan. Ambil kultur hanya bila tersedia dan tidak menunda antibiotik IV empiris. Pada syok, antibiotik diberikan segera, idealnya dalam satu jam. Rujuk dengan pemantauan. Kebutuhan vasopresor mempercepat rujukan karena Sukamaju tidak memiliki pompa, monitor, dan protokol yang diperlukan.',
    langkah: [
      {
        id: 'sep_1',
        narasi:
        ...
        pilihan: [
          {
            id: 'a',
            label:
              'Tegakkan syok secara klinis, beri oksigen, pasang akses IV besar, dan mulai kristaloid berbasis berat badan dengan penilaian ulang berkala',
            benar: true,
            efekStabilitas: 23,
            respons:
          ...
          },
          {
            ...
            efekStabilitas: -20,
            respons:
              'Vasopresor mungkin diperlukan bila hipotensi menetap, dan tidak selalu harus menunggu akses sentral. Namun ia tidak menggantikan resusitasi awal, antibiotik, dan rujukan; profil FKTP ini tidak punya pompa, pemantauan, atau protokol vasopresor perifer yang siap.',
          },
        ],
      },
      {
      ...
      },
      {
        id: 'sep_3',
        narasi:
          'Setelah cairan mendekati 30 mL/kg dengan penilaian ulang perfusi dan tanda kelebihan cairan, tekanan darahnya bertahan di 92/60, napas 26, dan kesadarannya sedikit membaik. ' +
  ...
  /* ====================================================================== */
  {
    ...
    clue:
      'Eklampsia adalah preeklampsia yang disertai kejang atau koma. Amankan ibu dari cedera, bebaskan jalan napas, miringkan ke kiri, dan beri oksigen. Magnesium sulfat adalah antikonvulsan pilihan; gunakan regimen PPK yang tersedia. Rumatan diteruskan selama rujukan hanya bila pemantauan aman dapat dijalankan; bila tidak, dosis awal lalu transfer cepat lebih aman daripada improvisasi. Sebelum dosis berikutnya, pastikan refleks patela masih ada, frekuensi napas >=16x/menit, dan produksi urin memadai. Bila napas <16x/menit, refleks patela hilang, atau terjadi oliguria berat, hentikan magnesium sulfat dan berikan kalsium glukonas 10% sesuai protokol. Diazepam hanya menjadi alternatif bila magnesium sulfat benar-benar tidak tersedia. Kendalikan hipertensi berat secara bertahap agar perfusi plasenta tidak turun mendadak. Persalinan adalah terapi definitif, sehingga pasien wajib dirujuk ke layanan obstetri dengan stabilisasi tetap berjalan. Acuan: PPK Dokter di FKTP KMK 1186/2022 dan WHO Pre-eclampsia Fact Sheet and Recommendations 2025.',
    langkah: [
      {
        id: 'ekl_1',
        narasi:
  ...
  /* ====================================================================== */
  {
    ...
    clue:
      'Sumbatan jalan napas oleh benda asing pada anak dinilai dari batuknya efektif atau tidak. Bila anak masih bisa bersuara, menangis, atau batuk BERBUNYI, dorong terus batuk dan awasi. Bila tidak ada suara, batuk tak berbunyi, atau sianosis, lakukan tindakan segera: pada anak di atas 1 tahun, 5 hentakan punggung bergantian dengan 5 hentakan perut; pada bayi, gunakan 5 hentakan punggung dan 5 hentakan dada, tanpa hentakan perut. Jangan melakukan sapuan jari buta; keluarkan hanya benda yang terlihat. Bila anak tidak sadar, mulai RJP dan lihat benda saat membuka jalan napas. Kasus ini dirujuk karena batuk/bunyi napas menetap setelah benda keluar menandakan kemungkinan sisa yang memerlukan bronkoskopi; anak yang pulih sempurna dapat diobservasi dan diberi safety-net. PPK FKTP 1186/2022 tidak memuat bab FBAO anak; algoritme mengikuti AHA/AAP Pediatric Basic Life Support 2025.',
    langkah: [
      {
        id: 'fbao_1',
        narasi:
  ...
  /* ====================================================================== */
  {
    ...
    clue:
      'Pneumotoraks tensi terjadi ketika udara masuk ke rongga pleura tetapi tidak dapat keluar. Tekanan yang meningkat mengempiskan paru dan menghambat aliran balik vena, sehingga timbul syok obstruktif. Diagnosisnya klinis: sesak progresif setelah trauma dada, satu sisi dada tertinggal dan hipersonor, suara napas menghilang, distensi vena leher, hipotensi, atau deviasi trakea. Jangan menunggu foto toraks. Beri oksigen aliran tinggi dan lakukan dekompresi segera oleh tenaga terlatih dengan alat serta lokasi sesuai protokol. Masukkan kateter di atas tepi iga untuk menghindari berkas neurovaskular, fiksasi, lalu pantau patensi dan kekambuhan selama perjalanan. Rujuk segera ke layanan bedah untuk drainase definitif. Acuan: PNPK Tata Laksana Trauma KMK 132/2017 dan PPK Dokter di FKTP KMK 1186/2022.',
    langkah: [
      {
        id: 'ptx_1',
        narasi:
