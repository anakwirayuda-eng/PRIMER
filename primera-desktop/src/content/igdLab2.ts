...
export const KASUS_IGD_LAB_2 = terapkanGroundingIgd([
  ...
  /* ====================================================================== */
  {
    ...
    clue:
      'Pneumotoraks tensi terjadi ketika udara masuk ke rongga pleura tetapi tidak dapat keluar. Tekanan yang meningkat mengempiskan paru dan menghambat aliran balik vena, sehingga timbul syok obstruktif. Diagnosisnya klinis: sesak progresif setelah trauma dada, satu sisi dada tertinggal dan hipersonor, suara napas menghilang, distensi vena leher, hipotensi, atau deviasi trakea. Jangan menunggu foto toraks. Beri oksigen aliran tinggi dan lakukan dekompresi segera oleh tenaga terlatih dengan alat serta lokasi sesuai protokol. Masukkan kateter di atas tepi iga untuk menghindari berkas neurovaskular, fiksasi, lalu pantau patensi dan kekambuhan selama perjalanan. Rujuk segera ke layanan bedah untuk drainase definitif. Acuan: PPK Dokter di FKTP KMK 1186/2022 dan prinsip ATLS.',
    langkah: [
      {
        id: 'ptx_1',
        narasi:
