 ...
 *
 * `judul` = nama merek tampilan (boleh berkembang — kini PRIMERA v1.0,
 * menyatukan simulator single-player ini dengan versi battle-kelas
 * "Arena" di primera-arena/). `judulTerdaftar` + `haki` TETAP nama & data
 * pencatatan HKI asli, verbatim — jangan disamakan dgn `judul` di atas.
 */

export const METADATA = {
  judul: 'PRIMERA: Puskesmas Pagi',
  ...
  disklaimerMedis:
    'PRIMERA adalah simulasi edukasi. BUKAN perangkat medis (SaMD), bukan pedoman ' +
