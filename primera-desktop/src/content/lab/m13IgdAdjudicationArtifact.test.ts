...
describe('M13-14 IGD adjudication artifact', () => {
  it('mencakup tepat seluruh prototipe IGD yang belum diadjudikasi', () => {
  ...
  it('menyalin seluruh algoritma, opsi, feedback, disposisi, dan sumber tanpa keputusan dokter palsu', () => {
    for (const compiled of DATA.cases) {
      ...
      expect(compiled).not.toHaveProperty('physicianDecision')
    }
  })
  ...
  it('artefak checked-in cocok dengan fingerprint dan menyediakan empat keputusan', () => {
