...
export const LAB_BATCH_4_OA_CASES: KasusKlinis[] = [
  ...
  buatKasusOA({
    ...
    panduanResmi: `${PPK_FLOOR} PPK Dokter FKTP menempatkan gizi buruk sebagai kompetensi 3B: dokter FKTP mengenali, memberi tata laksana awal fase stabilisasi, lalu merujuk. Pedoman Pencegahan dan Tatalaksana Gizi Buruk pada Balita Kemenkes menjabarkan 10 langkah yang urutannya sengaja tidak boleh ditukar — hipoglikemia dan hipotermia lebih dulu, baru dehidrasi, elektrolit, infeksi, mikronutrien, pemberian makan hati-hati, tumbuh kejar, stimulasi, dan tindak lanjut. Kriteria rujukan resminya adalah setiap gizi buruk DENGAN komplikasi (nafsu makan buruk atau tanda bahaya umum) dan setiap bayi di bawah 6 bulan dengan gizi buruk.`,
    ...
    konsekuensi: {
      ...
      guideline: 'PPK Dokter FKTP KMK 1186/2022 (gizi buruk, kompetensi 3B); Pedoman Pencegahan dan Tatalaksana Gizi Buruk pada Balita Kemenkes; WHO Guideline on the management of severe acute malnutrition (10 langkah tata laksana).',
    },
  }),
]
