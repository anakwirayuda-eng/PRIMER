...
export const LAB_BATCH_4_DALAM_CASES: KasusKlinis[] = [
  ...
  buatKasusLab({
    ...
    panduanResmi: `${PPK_FLOOR} PPK 1186/2022 memerinci oksigen bila hipoksemik, akses IV, furosemid injeksi 20-40 mg, dan rujukan segera pada gagal jantung akut. ESC 2021 dengan focused update 2023 menguatkan diuretik intravena untuk kongesti, pemantauan respons dan fungsi ginjal, pencarian pencetus, serta penyesuaian terapi kronik menurut stabilitas hemodinamik.`,
    ...
    konsekuensi: {
      ...
      guideline: 'PPK 1186/2022 / ESC Heart Failure 2021 + update 2023 — diuretik loop intravena, oksigen bila hipoksemik, monitoring, dan rujuk; terapi kronik disesuaikan menurut stabilitas.',
    },
  }),
  ...
  buatKasusLab({
    ...
    panduanResmi: 'PPK 1186/2022 tidak memuat bab Graves spesifik; bab tirotoksikosis menjadi acuan dasar terkait dan memuat propranolol, PTU bila klinis Graves jelas, serta rujukan untuk pemeriksaan laboratorium. ATA 2016 tetap menjadi guideline aktif untuk menegakkan tirotoksikosis, memastikan etiologi Graves, mengendalikan gejala secara aman, dan menilai keamanan sebelum obat antitiroid. Karena PTU bukan pilihan pertama rutin dan risiko terapi bergantung kehamilan serta monitoring, kasus Sukamaju hanya mewajibkan kontrol gejala yang aman dan rujukan, bukan PTU empiris.',
    ...
    konsekuensi: {
      ...
      guideline: 'PPK 1186/2022 bab tirotoksikosis / ATA Hyperthyroidism Guideline — kendalikan gejala dengan aman, konfirmasi TSH-FT4/FT3 dan etiologi, lalu pilih terapi definitif melalui jejaring.',
    },
  }),
  ...
  buatKasusLab({
    ...
    panduanResmi: 'PPK 1186/2022 bab anemia defisiensi besi adalah acuan dasar langsung: anemia bergejala segera dirujuk dan Hb <7 g/dL dicantumkan sebagai indikasi transfusi. WHO 2024 memperbarui batas hemoglobin untuk klasifikasi anemia, sedangkan AABB 2023 menganjurkan strategi restriktif dengan mempertimbangkan transfusi pada pasien dewasa rawat inap stabil saat Hb <7 g/dL serta tetap menilai gejala dan konteks. ACOG menempatkan stabilitas hemodinamik, derajat anemia, pola perdarahan, dan etiologi sebagai dasar evaluasi serta pilihan terapi perdarahan uterus abnormal.',
    ...
    konsekuensi: {
      ...
      guideline: 'PPK 1186/2022 / WHO 2024 / AABB 2023 / ACOG AUB — rujuk anemia berat bergejala, pertimbangkan transfusi berdasarkan Hb dan konteks, serta cari dan atasi sumber perdarahan.',
    },
  }),
  ...
  buatKasusLab({
    ...
    clue: `Gabungan temuan ini — ulkus plantar dalam bernanah dan berbau, nekrosis, selulitis lebih dari 2 cm, probe-to-bone positif, neuropati, dan penyakit arteri perifer — menunjukkan infeksi kaki diabetik sedang dengan komorbiditas kunci, dan tungkainya terancam. Hitung darah atau HbA1c tidak dibutuhkan untuk keputusan akut ini.

Yang dikerjakan di FKTP: nilai perfusi dan tanda sistemik; lindungi luka dengan balutan bersih nonadheren tanpa probing atau debridemen tajam; bebaskan area dari tekanan; pasang akses intravena; mulai antibiotik parenteral sesuai protokol jejaring; pantau; lalu transfer ke tim kaki diabetik yang punya bedah dan vaskular.

Yang BUKAN pekerjaan FKTP dan dikerjakan di rumah sakit: pencitraan tulang, kultur jaringan dalam, pembersihan sumber infeksi, revaskularisasi, dan pengendalian gula darah definitif.`,
    panduanResmi: `${PPK_FLOOR} PPK 1186/2022 tidak punya bab lengkap untuk infeksi kaki diabetik; bab diabetes hanya sumber terkait.

IWGDF/IDSA 2023 memberi tiga ambang keputusan. Rawat inap untuk infeksi berat, atau infeksi sedang yang disertai komorbiditas penting seperti penyakit arteri perifer. Konsultasi bedah segera bila ada gangren, nekrosis, abses dalam, atau iskemia berat. Konsultasi bedah dan vaskular bersama untuk menentukan mana yang lebih dulu — drainase/debridemen atau revaskularisasi.

Satu catatan penting: probe-to-bone hanya bagian dari evaluasi awal osteomielitis. Hasilnya tidak meniadakan kebutuhan pencitraan atau kultur tulang.`,
