...
export const DUEL_DIAGNOSIS_PILOTS: readonly DuelDiagnosisPilot[] = [
  ...
  },
  {
    ...
    pembeda: 'Tinea memiliki tepi aktif bersisik dan central clearing; dermatitis mengikuti pola pajanan tanpa tepi aktif khas.',
    pembalik: 'KOH positif atau tepi annular aktif menggeser ke tinea; hubungan pajanan yang tegas menggeser ke dermatitis.',
    pertanyaan: 'Temuan mana paling mendukung tinea dibanding dermatitis kontak?',
    pilihan: [
      { id: 'tepi', label: 'Tepi annular aktif bersisik dengan central clearing', benar: true, respons: 'Benar. Ambil kerokan dari tepi aktif bila konfirmasi KOH tersedia.' },
      { id: 'gatal', label: 'Keluhan gatal', benar: false, respons: 'Gatal lazim pada keduanya dan bukan pembeda kuat.' },
      { id: 'merah', label: 'Kulit tampak kemerahan', benar: false, respons: 'Eritema juga nonspecific dan harus dibaca bersama morfologi serta pajanan.' },
    ],
  ...
  },
  {
    ...
    pilihan: [
      ...
      { id: 'urat', label: 'Satu hasil asam urat normal', benar: false, respons: 'Asam urat dapat normal saat flare dan tidak menyingkirkan gout.' },
    ],
    sumber: [
  ...
  },
  {
    ...
    pembeda: 'Heartburn retrosternal dan regurgitasi menunjuk GERD; nyeri epigastrium, cepat kenyang, dan penuh pascamakan menunjuk dispepsia.',
    ...
    pilihan: [
      { id: 'regurgitasi', label: 'Regurgitasi asam dan heartburn yang memberat saat berbaring', benar: true, respons: 'Benar. Kombinasi ini lebih khas refluks gastroesofageal.' },
...
const pilihanPembuka = (fokus: string): readonly PilihanFormatif[] => [
  ...
  },
  {
    ...
    benar: false,
    respons: 'Bahasa menyalahkan membuat pasien menyembunyikan kebingungan dan bertentangan dengan teach-back.',
  },
]
...
const pilihanPenilaian = (aksi: string): readonly PilihanFormatif[] => [
  ...
  },
  {
    ...
    benar: false,
    respons: 'Pengulangan parsial masih menyisakan tindakan berisiko; lakukan re-teach singkat.',
  },
]
...
export const TEACH_BACK_PILOTS: readonly TeachBackPilot[] = [
  {
    ...
    kasusId: 'asma_ringan',
    judul: 'Show-me teknik inhaler',
    fokus: 'cara memakai inhaler satu kali dari awal sampai selesai',
    pertanyaanPembuka: 'Prompt mana paling aman untuk memulai show-me?',
  ...
  },
  {
    ...
    judul: 'Teach-back oralit dan asupan',
    fokus: 'apa yang akan dilakukan di rumah setelah setiap BAB cair',
    pertanyaanPembuka: 'Prompt mana paling aman untuk memeriksa rencana keluarga?',
  ...
  },
  {
    ...
    judul: 'Teach-back aturan 15-15',
    fokus: 'apa yang dilakukan bila gula kurang dari 70 dan masih sadar',
    pertanyaanPembuka: 'Prompt mana paling aman untuk memeriksa pemahaman pasien?',
  ...
  },
  {
    id: 'teachback-tb',
    kasusId: 'tb_paru',
    judul: 'Teach-back kesinambungan terapi TB',
    fokus: 'rencana minum obat dan siapa yang dihubungi bila ada masalah',
    pertanyaanPembuka: 'Prompt mana paling aman untuk memeriksa rencana pengobatan?',
  ...
  },
  {
    ...
    judul: 'Teach-back kesiapan hipoglikemia pada insulin',
    fokus: 'langkah saat gemetar atau berkeringat setelah insulin',
    pertanyaanPembuka: 'Prompt mana paling aman untuk memeriksa rencana pasien?',
  ...
  },
  {
    ...
    judul: 'Teach-back antibiotik dan safety-net',
    fokus: 'cara minum obat dan kapan harus kembali lebih cepat',
    pertanyaanPembuka: 'Prompt mana paling aman untuk memeriksa rencana pulang?',
  ...
  },
  {
    ...
    judul: 'Show-me teknik tetes telinga',
