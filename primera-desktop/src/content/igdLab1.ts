...
export const KASUS_IGD_LAB_1 = terapkanGroundingIgd([
  /* ====================================================================== */
  {
    ...
    clue:
      'Status epileptikus adalah kejang lebih dari lima menit, atau kejang berulang tanpa pemulihan kesadaran. Setiap menit tambahan membuat kejang makin sulit dihentikan. Miringkan pasien, lindungi kepala, bebaskan jalan napas, dan beri oksigen. Jangan memasukkan benda ke mulut. Pasang akses IV dan monitor, lalu periksa gula darah kapiler untuk mencari hipoglikemia yang dapat segera dikoreksi. Benzodiazepin adalah terapi lini pertama dan dapat diulang satu kali sesuai protokol; antiepileptik lini kedua diberikan sesudahnya. Bila kejang menetap setelah dosis benzodiazepin yang adekuat, pertahankan jalan napas dan oksigenasi selama rujukan emergensi ke layanan saraf. Acuan: PNPK Tata Laksana Epilepsi Dewasa 2026, definisi status epileptikus ILAE, dan WHO Antiseizure Medicines for Established Status Epilepticus 2023.',
    langkah: [
      {
        id: 'se_1',
        narasi:
  ...
  /* ====================================================================== */
  {
    ...
    spesialisRujukan: 'bedah',
    clue:
      'Luka bakar derajat II-III seluas sekitar 25% permukaan tubuh dapat menyebabkan kebocoran plasma, syok, dan infeksi. Hentikan proses bakar: lepaskan pakaian panas serta perhiasan, lalu dinginkan dengan air mengalir bersuhu ruang sekitar 20 menit. Jangan gunakan es. Nilai ABC dan curigai cedera inhalasi pada kebakaran ruang tertutup, suara serak, bulu hidung hangus, atau jelaga di mulut. Ancaman jalan napas harus ditangani lebih dahulu. Pasang akses IV besar dan mulai kristaloid terhitung; formula Parkland dihitung sejak waktu terbakar dan dititrasi menurut respons klinis serta produksi urin. Jangan mengoleskan odol, kecap, minyak, atau mentega. Tutup luka secara bersih dan rujuk ke pusat luka bakar. Acuan: PNPK Tata Laksana Luka Bakar KMK 555/2019 dan PPK Dokter di FKTP KMK 1186/2022.',
    langkah: [
      {
        id: 'lb_1',
        narasi:
  ...
  /* ====================================================================== */
  {
    ...
    clue:
      'Pada asfiksia neonatorum, tindakan penentu biasanya ventilasi, bukan obat atau kompresi dini. Dalam 30 detik pertama, hangatkan bayi, posisikan kepala setengah tengadah, bersihkan jalan napas hanya bila perlu, keringkan, dan beri rangsang taktil. Bila bayi tetap apnea atau megap-megap, atau laju jantung kurang dari 100 per menit, mulai ventilasi tekanan positif dengan balon-sungkup 40-60 kali per menit. Pastikan sungkup rapat dan dada mengembang. Nilai kembali laju jantung setelah 30 detik ventilasi efektif. Kompresi dada rasio 3:1 baru ditambahkan bila laju jantung masih kurang dari 60 per menit; ventilasi tetap berjalan. Hindari pengisapan dalam secara rutin karena dapat memicu bradikardia dan menunda ventilasi. Acuan: Panduan Provider Resusitasi Neonatus IDAI Resneo ID 2024 dan AHA/AAP Neonatal Resuscitation Guidelines 2025.',
    langkah: [
      {
        id: 'an_1',
        narasi:
