/** Label ICD tambahan yang harus ikut diaktifkan agar Deck Diagnosis tidak bocor lewat "Kode X". */
export const M13_1A_PROPOSED_ICD10_ENTRIES: Record<string, string> = {
