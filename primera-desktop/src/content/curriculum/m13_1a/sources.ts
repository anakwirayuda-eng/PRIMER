...
const M13_1A_SOURCE_DRAFTS: Omit<M13AuthoringSource, 'retrievedAt' | 'lifecycleStatus'>[] = [
  ...
  },
  {
    ...
    limitation: 'Menganjurkan irigasi sepintas kontaminan tampak di UGD; rekomendasi ini berkonflik dengan NICE NG37 dan BOAST tentang mini-washout.',
  },
  {
    id: 'nice:ng37-fractures-complex-2022',
    issuer: 'National Institute for Health and Care Excellence',
    title: 'NG37 Fractures (complex): assessment and management',
    publicationDate: '2016-02-17',
    officialUrl: 'https://www.nice.org.uk/guidance/ng37/chapter/recommendations',
    population: 'Anak dan dewasa dengan fraktur kompleks; rekomendasi luka berlaku pada fraktur terbuka tulang panjang',
    facilityScope: 'Pra-rumah sakit dan emergency department; terakhir diperbarui 23 November 2022',
    limitation: 'Pedoman UK; adaptasi Indonesia wajib mempertahankan floor Kemenkes, kapasitas stabilisasi, dan jejaring lokal.',
  },
  {
