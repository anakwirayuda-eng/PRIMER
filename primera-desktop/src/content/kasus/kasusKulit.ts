...
export const KASUS_KULIT: KasusKlinis[] = [
   ...
   * ==================================================================== */
  {
    ...
    harusDirujuk: false,
    prevalensi: 'sedang',
    keluhanUtama: 'Anak saya punya beberapa koreng di sekitar hidung dan mulut, dok, dan jumlahnya makin banyak.',
    ...
    anamnesis: [
      ...
      },
      {
        ...
        tanya: 'Seperti apa warna dan permukaan korengnya?',
   ...
   * ==================================================================== */
  {
    ...
    anamnesis: [
      ...
      },
      {
        ...
        jawab: 'Orang yang sering berinteraksi dengan saya dua minggu lalu kena cacar air, dok.',
        esensial: true,
        oldcarts: ['penyerta'],
      },
      {
   ...
   * ==================================================================== */
  {
    ...
    harusDirujuk: false,
    prevalensi: 'sedang',
    keluhanUtama: 'Anak saya demam tinggi beberapa hari, lalu sejak kemarin muncul ruam merah, dok.',
    keluhanUtamaOlehPendamping: true,
    ...
    anamnesis: [
      {
        ...
        jawab: 'Demamnya sudah 3-4 hari, dok. Kemarin baru muncul ruam merah di wajah; hari ini ruamnya mulai terlihat di badan.',
        variasi: {
