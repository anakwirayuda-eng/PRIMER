...
export const WILAYAH_LAYER_META = {
    ...
    pispk: {
        ...
        chipBg: 'rgba(7,38,56,0.84)',
        chipBorder: 'rgba(56,189,248,0.3)',
        chipText: 'rgba(224,242,254,0.96)',
        showServiceCoverage: true,
        showServiceLabels: true,
        serviceRingOpacity: 0.56,
        legendItems: [
    ...
    surveillance: {
        ...
        chipBg: 'rgba(68,8,25,0.86)',
        chipBorder: 'rgba(251,113,133,0.3)',
        chipText: 'rgba(255,228,230,0.96)',
        showServiceCoverage: true,
        showServiceLabels: true,
        serviceRingOpacity: 0.48,
        legendItems: [
    ...
    psn: {
        ...
        chipBg: 'rgba(48,77,18,0.84)',
        chipBorder: 'rgba(163,230,53,0.3)',
    ...
    phbs: {
        ...
        chipBg: 'rgba(74,9,34,0.86)',
        chipBorder: 'rgba(244,114,182,0.3)',
        chipText: 'rgba(252,231,243,0.96)',
        showServiceCoverage: true,
        showServiceLabels: true,
        serviceRingOpacity: 0.54,
        legendItems: [
    ...
    perilaku: {
        ...
        chipBg: 'rgba(28,28,70,0.86)',
        chipBorder: 'rgba(129,140,248,0.3)',
        chipText: 'rgba(224,231,255,0.96)',
        showServiceCoverage: true,
        showServiceLabels: true,
        serviceRingOpacity: 0.52,
        legendItems: [
