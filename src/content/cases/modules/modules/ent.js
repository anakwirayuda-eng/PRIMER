...
export const ENT_CASES = [
    ...
    },
    {
        ...
        anamnesisQuestions: {
            ...
            rpd: [
                { id: 'q_recur', text: 'Sering radang tenggorokan?', response: 'Sering dok, sudah 4-5 kali tahun ini.', sentiment: 'confirmation' },
            ],
            rpk: [],
            sosial: [],
        },
    ...
    },
    {
        ...
        anamnesisQuestions: {
            ...
            rpd: [
                { id: 'q_prev', text: 'Pernah sakit telinga sebelumnya?', response: 'Pernah dok, setahun lalu juga pernah.', sentiment: 'confirmation' },
            ],
            rpk: [],
            sosial: [],
        },
