...
| :--- | :--- | :--- | :--- |
| **Honest Health** | **GREEN** | **YES** | **Score: 85/100** |
| **Arch Overview** | PASS | YES | Bridge Synchronized |
| **Clinical** | PASS | YES | 100% integrity |
| **MAIA Integ.** | passed | YES | M=0 P=0 E=0 |
| **Lint Budget** | WARN | YES | 37 errors |
| **Unit Tests** | PASS | YES | 17 passed, 0 failed |
| **Invariants** | PASS | YES | 100% coverage (100%) |
| **Lifecycle** | PASS | YES | FSM state monitor |
| **Triage Gate** | PASS | YES | Safety enforcement |
| **Forensic** | PASS | YES | 0 undefined symbols |
| **Assets** | PASS | YES | hygiene check |
| **Build Guard** | PASS | YES | Vite production gate |
| **Smoke (E2E)** | SKIP | NO | 0 failed tests |
...
| :--- | :--- | :--- |
| **Health Score** | **95/100** | Overall structural integrity |
| **Indexing** | ⚠️ | 92% coverage (10% weight) |
| **Lint** | ⚠️ | 37 errors, 5 warnings (15% weight) |
| **Graph Integrity** | ✅ | 70% purity (5% weight) |
| **Clinical** | ✅ | 100% clinical health (15% weight) |
| **Unit Tests** | ✅ | 17 passed, 0 failed (15% weight) |
| **Store Contract** | ✅ | 5 slices audited |
| **Save Integrity** | ✅ | v5 persistence check |
...
- **[Monster File]** in `src/game/PatientGenerator.js`: Large file (1017 LOC). Consider splitting.
- **[Monster File]** in `src/store/useGameStore.js`: Large file (1542 LOC). Consider splitting.
...
| [GameCore](#mod-GameCore.js) | Stable | 🟢 4 | Pure game mechanics extracted for headless simulation and lo... |
...
| 🔴 | `src/store/useGameStore.js` | 93.8K | 1542 | 4 | 🟡 Consider decomposing |
...
| 🟢 | `src/content/cases/modules/modules/digestive.js` | 49.1K | 727 | 1 | — |
| 🟢 | `src/components/wilayah/3d/BuildingRenderer.jsx` | 48.9K | 798 | 1 | — |
| 🟢 | `src/data/ICD10.js` | 46.8K | 704 | 2 | — |
| 🟢 | `src/components/wilayah/PosyanduActivePanel.jsx` | 45.6K | 606 | 1 | — |
| 🔴 | `src/game/PatientGenerator.js` | 42.6K | 1017 | 1 | 🟡 Consider decomposing |
...
| 🟢 | `src/components/wilayah/MiniGamePanel.jsx` | 39.4K | 610 | 1 | — |
| 🟢 | `src/pages/RumahDinas.jsx` | 39.0K | 709 | 0 | — |
